from models import gen_upsample_layer
...
def skip(model_index,
    ...
    encoder_decoder_pair = len(num_channels_down)  # number of encoder-decoder groups
    ...
    for i in range(encoder_decoder_pair):
        ...
        input_channel = num_channels_down[i]
        output_channel = num_channels_down[i]

        deep_conv.add_module('upsample layer', gen_upsample_layer.gen_layer(C_in=input_channel,
